  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4 transition-colors">
    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="mt-6 text-2xl font-bold text-gray-900 dark:text-white">Create an account</h1>
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Sign up to get started</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-sm">
        ...
        <p class="mt-6 text-center text-sm text-gray-500 dark:text-gray-500">
          ...
          <RouterLink to="/login" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 font-medium">
            Sign in
          </RouterLink>
        </p>
      </div>
